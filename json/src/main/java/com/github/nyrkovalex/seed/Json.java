...
public final class Json {
  ...
  public interface File<T> {
    ...
    /**
     * <p>
     * Reads file if exists and returns its content as an {@link Optional} of type <code>T</code>.
     * </p>
     * <p>
     ...
     * @throws Json.Err if <code>data</code> cannot be dumped to json or file cannot be written to
