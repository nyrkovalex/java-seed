...
public final class Plugins {
	...
	public static interface Repo {
		...
		/**
		 * Instantiates an object of a class specified by <code>className</code>
		 * using its default constructor.
		 *
		 * @param className name of a class to load, e.g. <code>my.package.MyClass</code>
		 * @return instance of a class requested
		 * @throws Plugins.Err if do default constructor can be found or it's not
		 * accessible or hell knows why
		 */
...
class PlugLoader implements Plugins.Repo {
