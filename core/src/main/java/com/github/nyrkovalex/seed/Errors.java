...
public class Errors {
    ...
    public interface Catcher<T extends Throwable> {
        ...
        /**
         * <p>
         * Calls an {@link VoidUnsafeCall} capturing any exception of an expected type and throwing
         * a {@link RuntimeException} wrapping a throwable of any other type if thrown.
         * </p>
         * <p>
