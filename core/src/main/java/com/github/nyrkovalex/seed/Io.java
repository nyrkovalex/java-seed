...
public final class Io {
	...
	public interface File extends Entity {
		...
		void copyTo(Entity target) throws Io.Err;
	}
	...
	private static class IoFile extends IoEntity implements Io.File {
		...
		@Override
		public void copyTo(Entity target) throws Err {
			Path otherPath = Paths.get(target.path());
			Path targetPath = Files.isDirectory(otherPath)
					? otherPath.resolve(this.path)
					: otherPath;
			Errors.rethrow(() -> {
				Files.copy(
						this.path,
